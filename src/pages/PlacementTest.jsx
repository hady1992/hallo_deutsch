      ...
      return (
        <div className="min-h-screen pt-24 pb-12 bg-slate-50 px-4 flex items-center justify-center">
            <div className="text-center text-slate-500">
                <Loader2 className="animate-spin w-10 h-10 mx-auto mb-4 text-blue-500" />
    ...
    return (
      <div className="min-h-screen pt-24 pb-12 bg-slate-50 px-4" dir="rtl">
        ...
        <div className="max-w-3xl mx-auto text-center space-y-8 animate-in zoom-in-95 duration-500">
           <Card className="border-t-4 border-t-blue-600 shadow-xl overflow-hidden">
             <div className="bg-blue-50/50 p-8 pb-0">
             ...
             <CardContent className="p-8 space-y-8">
               <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  ...
                  <div className="p-4 rounded-2xl bg-blue-50 border border-blue-100 ring-2 ring-blue-100">
                     <div className="text-sm text-blue-600 uppercase font-bold tracking-wider mb-1">المستوى المناسب</div>
                     <div className="text-4xl font-black text-blue-700">{result.recommendedLevel}</div>
                  </div>
                  <div className="p-4 rounded-2xl bg-slate-50 border border-slate-100">
               ...
               <div className="bg-slate-50 p-6 rounded-2xl border border-slate-200 text-right">
                  ...
                  <p className="text-slate-600 leading-relaxed">
                    بناءً على نتيجتك، نوصي بالبدء في دراسة <span className="font-bold text-blue-600">المستوى {result.recommendedLevel}</span>. 
                    هذا المستوى يتناسب بشكل أفضل مع معرفتك الحالية بالقواعد والمفردات.
                  </p>
               </div>

               <div className="flex flex-col sm:flex-row gap-4 justify-center pt-4">
                  <Button onClick={() => window.location.href = `/level/${result.recommendedLevel.toLowerCase()}`} className="h-12 px-8 text-lg bg-blue-600 hover:bg-blue-700 text-white shadow-lg hover:shadow-blue-200 transition-all rounded-xl gap-2">
         ...
         <div className="max-w-3xl mx-auto">
            ...
            <div className="flex items-center justify-between mb-6 text-sm font-medium text-slate-500">
              ...
              <span className={`px-2 py-0.5 rounded text-xs font-bold bg-white border ${
                  ...
                  currentQuestion.level === 'A2' ? 'text-blue-600 border-blue-200' :
                      ...
                      {currentQuestion.options.map((opt, idx) => (
                          ...
                          >
                             <div className={cn(
                                ...
                                {answers[currentQuestionIndex] === idx && <div className="w-3 h-3 bg-blue-600 rounded-full" />}
                             </div>
                             <span className={cn(
                                 "text-lg font-medium transition-colors flex-grow text-right",
                                 answers[currentQuestionIndex] === idx ? "text-blue-900" : "text-slate-700"
                             )} dir="auto">{opt}</span>
                          </div>
                      ))}
                   </CardContent>
  ...
  return (
    <div className="min-h-screen pt-24 pb-12 bg-slate-50 px-4" dir="rtl">
      ...
      <div className="max-w-4xl mx-auto text-center pt-8">
        ...
        >
            <div className="bg-gradient-to-r from-blue-600 to-indigo-600 p-12 text-white">
            ...
            <div className="p-8 md:p-12">
                <div className="grid md:grid-cols-3 gap-8 mb-12">
                    <div className="text-center p-4">
                        <div className="bg-blue-50 w-12 h-12 rounded-full flex items-center justify-center mx-auto mb-3 text-blue-600 font-bold">40</div>
                        <h3 className="font-bold text-slate-800">سؤال</h3>
                        <p className="text-sm text-slate-500">تغطية شاملة</p>
                    </div>
                    <div className="text-center p-4">
                        <div className="bg-purple-50 w-12 h-12 rounded-full flex items-center justify-center mx-auto mb-3 text-purple-600 font-bold">20د</div>
