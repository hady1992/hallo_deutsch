            ...
            <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="space-y-2">
                    ...
                    <textarea 
                        ...
                        rows="3"
                        className="w-full p-2.5 border border-slate-200 rounded-lg focus:ring-2 focus:ring-blue-500 outline-none transition-all resize-none"
                    />
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 bg-slate-50 p-4 rounded-xl border border-slate-100">
                    <div className="space-y-2">
                        <label className="text-sm font-medium text-slate-700 flex items-center gap-2">
                            <FileText size={16} className="text-blue-500"/> ملف PDF (الأسئلة)
                        </label>
                        <input 
                            type="file" 
                            ...
                            className="w-full text-sm text-slate-500 file:mr-4 file:py-2 file:px-4 file:rounded-lg file:border-0 file:text-sm file:font-semibold file:bg-blue-600 file:text-white hover:file:bg-blue-700 cursor-pointer"
                        />
                    ...
                    <div className="space-y-2">
                        <label className="text-sm font-medium text-slate-700 flex items-center gap-2">
                             <FileAudio size={16} className="text-purple-500"/> ملف الصوت (للاستماع)
                        </label>
                        <input 
                            type="file" 
                            accept="audio/*"
                            ...
                            className="w-full text-sm text-slate-500 file:mr-4 file:py-2 file:px-4 file:rounded-lg file:border-0 file:text-sm file:font-semibold file:bg-purple-600 file:text-white hover:file:bg-purple-700 cursor-pointer"
                        />
                         <p className="text-xs text-slate-400 flex items-center gap-1">
            ...
            {models.length === 0 ? (
                ...
                >
                    <div className="flex justify-between items-start mb-3">
                        <Badge className="bg-purple-100 text-purple-800 hover:bg-purple-200">{model.level || '?'}</Badge>
                    ...
                    <div className="flex items-center gap-2 mt-auto pt-4 border-t border-slate-100">
                        {model.pdfUrl ? (
                            <a 
                                ...
                                className="flex-1 inline-flex items-center justify-center gap-2 text-xs font-medium bg-blue-50 hover:bg-blue-100 text-blue-700 py-2.5 rounded-lg transition-colors"
                            >
                        ...
                        {model.audioUrl ? (
                            <Button 
                                ...
                                className={cn("flex-1 gap-2 text-xs py-2.5 h-auto", playingAudio === model.audioUrl ? "bg-purple-600 hover:bg-purple-700 text-white" : "bg-purple-50 text-purple-700 hover:bg-purple-100")}
