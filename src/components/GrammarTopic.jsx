  ...
  return (
    ...
    >
      ...
      <div className="bg-gradient-to-r from-blue-700 to-indigo-800 p-8 md:p-12 text-white relative overflow-hidden">
        ...
        <div className="absolute bottom-0 left-0 w-64 h-64 bg-purple-500 opacity-10 rounded-full -ml-10 -mb-10 blur-2xl"></div>
        ...
        <div className="relative z-10">
            ...
            <span className="bg-blue-600/50 border border-blue-400/30 px-3 py-1 rounded-full text-sm font-medium uppercase tracking-wider">
            ...
            <p className="text-blue-100 text-lg md:text-xl max-w-2xl leading-relaxed opacity-90 font-light">
            {topic.content.intro}
            </p>
        </div>
      </div>
        ...
        <div className="flex flex-col md:flex-row gap-4 mb-8 sticky top-0 z-20 py-4 bg-slate-50/95 backdrop-blur-sm border-b border-slate-200">
          <div className="relative flex-1">
            ...
            <input 
              ...
              className="w-full pr-10 pl-4 py-3 rounded-xl border border-slate-200 shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 bg-white"
            />
          </div>
