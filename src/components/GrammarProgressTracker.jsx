...
const GrammarProgressTracker = ({ total, completed, level }) => {
  ...
  return (
    <div className="bg-gradient-to-br from-amber-900 to-amber-900 rounded-2xl p-6 text-white shadow-xl relative overflow-hidden mb-6">
      ...
      <div className="relative z-10 flex items-center justify-between mb-4">
        <div>
          <h3 className="text-amber-200 text-sm font-medium mb-1">تقدم المستوى {level}</h3>
          <div className="text-3xl font-bold flex items-baseline gap-2">
            {percentage}%
            <span className="text-sm font-normal text-amber-300 opacity-70">مكتمل</span>
          </div>
        </div>
      ...
      <div className="mt-4 flex justify-between items-center text-xs text-amber-200 font-medium bg-white/5 p-2 rounded-lg">
