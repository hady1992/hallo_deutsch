  ...
  if (!exercises || exercises.length === 0) {
    return (
      <div className="text-center py-12 bg-slate-50 rounded-lg border-2 border-dashed border-slate-200">
        ...
        <p className="text-slate-500">Try adjusting your filters or add a new exercise.</p>
      </div>
    );
  }
              ...
              {ex.options.map((opt, i) => (
                ...
                >
                  <span className={cn(
                    ...
                    i === ex.correctAnswer ? "bg-green-200 text-green-900" : "bg-slate-100 text-slate-500"
                  )}>
