...
const CourseUnitCard = ({ unit, level, getStatus }) => (
  <section className="border-t-2 border-[#e8b21e] pt-5">
    <div className="mb-5 flex flex-col justify-between gap-2 sm:flex-row sm:items-end">
      <div>
        <p dir="ltr" className="german-text text-sm font-bold text-[#b08000]">{unit.unitTitleDe || unit.unit}</p>
        <h2 className="mt-1 text-2xl font-black text-[#111111]">{unit.unitTitleAr}</h2>
      </div>
